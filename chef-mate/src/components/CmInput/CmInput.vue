<template>
  ...
  >
    ...
    <input
      class="w-full h-14 bg-white dark:bg-[#f8f7f5] border border-gray-100 dark:border-gray-200 text-text-main dark:text-text-main rounded-[20rpx] text-md transition-all duration-300 shadow-sm focus:border-primary focus:shadow-[0_0_0_2px_rgba(var(--primary),0.2)]"
