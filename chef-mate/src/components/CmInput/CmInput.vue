<template>
  <view class="relative flex items-center" :class="customClass">
    <view
    ...
    <input
      class="w-full h-14 bg-white border border-gray-100 rounded-[20rpx] pl-14 text-md transition-all duration-300 shadow-sm focus:border-primary focus:shadow-[0_0_0_2px_rgba(var(--primary),0.2)]"
      :class="[inputClass]"
      :type="type"
      :password="password"
