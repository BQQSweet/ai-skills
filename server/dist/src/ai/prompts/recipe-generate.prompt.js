...
exports.buildRecipeGeneratePrompt = buildRecipeGeneratePrompt;
function buildRecipeGeneratePrompt(ingredients, preferences, memberCount) {
    return [
        {
            role: 'system',
...
//# sourceMappingURL=recipe-generate.prompt.js.map